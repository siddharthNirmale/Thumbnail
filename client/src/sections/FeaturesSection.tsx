    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI understands what makes a video go viral and designs thumbnails that boost your click-through rates. Say goodbye to generic, boring thumbnails and hello to eye-catching designs that get noticed.
